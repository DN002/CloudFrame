...
public final class PipeKey {
    ...
    public PipeKey(String worldId, int x, int y, int z) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PipeKey that)) return false;
